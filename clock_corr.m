...
delta_Tsv_C1 = a0 + a1.*(t-Toc_C1)+a2.*(t-Toc_C1).^2+delta_rel;
delta_Tsv_P1 = a0 + a1.*(t-Toc_P1)+a2.*(t-Toc_P1).^2+delta_rel;
delta_Tsv_P2 = a0 + a1.*(t-Toc_P2)+a2.*(t-Toc_P2).^2+delta_rel;
end